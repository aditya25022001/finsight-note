...
import { addNote, getNotes, updateNote, deleteNote, getNoteById, shareNote } from '../controllers/noteController.js'
...
router.route('/sharenote').put(authenticate, shareNote)
